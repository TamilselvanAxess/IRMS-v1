...
import {getFinancialData , 
    ...
    getEmployeeDetailsSummary, getLoanCandidatesByMonth} from "../controllers/dashboardController.js";
...
router.get('/loanstatistics', getLoanStatisticsByMonth);
router.get('/candidate/loan-candidates', getLoanCandidatesByMonth);
